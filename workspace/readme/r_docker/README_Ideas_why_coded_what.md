...
### 2. Easy clean-up of 3rd party software from a computer's Host OS and filesystem.
Software deinstallation in theory easier: stopping, removing docker service, clearing service and installed docker images from installations cache.
