...
if [[ "${tarball_installed}" != "true" ]]; then
  ...
  cp "${BASH_LOGIN}" "/home/${USER_JAISOCX_NAME}/.bashrc"
  chown "${USER_JAISOCX_NAME}:${GROUP_JAISOCX_NAME}"    "/home/${USER_JAISOCX_NAME}/.bashrc"
  chmod 700   "/home/${USER_JAISOCX_NAME}/.bashrc"
